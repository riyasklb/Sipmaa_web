                    ...
                    Padding(
                      ...
                      child: Column(
                       ...
                       index==1?ElevatedButton(
                        ...
                        onPressed: (){}, child: Row(
                          children: [
                            Icon(Icons.filter_alt_rounded,color: kblue,),
                            ksizedbox10,
                            Padding(
                              padding: const EdgeInsets.only(top: 5,left: 6),
                              child: Text('Filter',
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.filter_alt_rounded,color: kwhite,),
                              Padding(
                                padding: const EdgeInsets.only(top: 5,left: 6),
                                child: Text('Filter',
                                style: TextStyle(color: kwhite),),
                    ...
                    Padding(
                      ...
                      child: Column(
                       ...
                       index==1?ElevatedButton(
                        ...
                        onPressed: (){}, child: Row(
                          children: [
                            Icon(Icons.notifications,color: kblue,),
                            ksizedbox10,
                            Padding(
                              padding: const EdgeInsets.only(top: 5,left: 6),
                ...
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                                Padding(
                                  ...
                                  child: Image.asset('assets/images/profile.png',fit: BoxFit.fitHeight,height: 21,),
                                ),
                              Padding(
                                padding: const EdgeInsets.only(top: 5,left: 6),
                                child: Column(
